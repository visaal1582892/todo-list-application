...
let AddTask = (props) => {
    ...
    return (
        <div className="flex flex-col w-[90%] justify-around items-center mt-7">
            <button className="button" onClick={handleClick}>Add Task</button>
            {showInput && <section id="addTask" className="mt-8">
                <h2 className="font-semibold text-lg text-center">Enter your task here. </h2>
